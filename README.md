...
This is the official implementation of ICRA 2042 paper. "Breaking Data Silos: Cross-Domain Learning for Multi-Agent
Perception from Independent Private Sources".
...
<p align="center">
  <img src="./imgs/DBS_V2V.png" alt="teaser" width="90%" height="90%">
</p>

 
## Data  Download

Our experiments are conducted on two publicly available benchmark datasets for V2V/V2X cooperative perception tasks: OPV2V and V2XSet. You can download these data from [OPV2V]() and [V2XSet]().
