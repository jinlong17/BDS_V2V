...
def inference_early_fusion(batch_data, model,model_B, dataset):
    """
    ...
    output_dict['ego'] = model(cav_content,model_B)
...
def inference_intermediate_fusion(batch_data, model,model_B, dataset):
    """
    Model inference for early fusion.
    ...
    gt_box_tensor : torch.Tensor
        The tensor of gt bounding box.
    """
    return inference_early_fusion(batch_data, model,model_B, dataset)
